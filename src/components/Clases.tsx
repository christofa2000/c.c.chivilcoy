  ...
  return (
    <section id="clases" className="py-8">
      <div className="max-w-5xl mx-auto px-4 py-4">
        <h2
          className="text-3xl text-center mb-4 tracking-wide text-white"
          ...
          >
            ...
            <div className="p-3 sm:p-4 md:p-6 overflow-y-auto">
              ...
              <div className="mt-4 sm:mt-5 flex flex-wrap gap-2">
                <button
                  type="button"
                  className="inline-flex items-center gap-2 rounded-xl px-3 py-2 ring-1 ring-black/10 shadow hover:shadow-md active:translate-y-px transition text-[15px]"
                  style={{
                    fontFamily: "var(--font-raleway), system-ui, sans-serif",
                  }}
                  onClick={() => setOpen(false)}
